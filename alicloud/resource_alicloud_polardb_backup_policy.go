...
func resourceAlicloudPolarDBBackupPolicyRead(d *schema.ResourceData, meta interface{}) error {
	...
	logBackupRetentionPeriod, _ := logBackupPolicy["LogBackupRetentionPeriod"].(json.Number).Int64()
	d.Set("log_backup_retention_period", strconv.FormatInt(logBackupRetentionPeriod, 10))
	enableBackupLog, _ := logBackupPolicy["EnableBackupLog"].(json.Number).Int64()
	d.Set("enable_backup_log", strconv.FormatInt(enableBackupLog, 10))
...
func resourceAlicloudPolarDBBackupPolicyUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChanges("preferred_backup_time", "backup_retention_policy_on_cluster_deletion", "data_level1_backup_retention_period", "data_level2_backup_retention_period",
		"backup_frequency", "data_level1_backup_frequency", "data_level1_backup_time", "data_level2_backup_another_region_region", "data_level2_backup_another_region_retention_period",
		"backup_retention_period") {
		update = true
